...
public class IngredientDrawer : PropertyDrawer {
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
        ...
        var x = property.FindPropertyRelative("x").intValue;
        var y = property.FindPropertyRelative("y").intValue;
        var z = property.FindPropertyRelative("z").intValue;

        var vector3 = new Vector3(x, y, z);
        EditorGUI.Vector3Field(position, label, vector3);
